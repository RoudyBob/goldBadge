    ...
    season1: {
        seasonInfo: {
            episodeInfo: [
                ...
                {episode: 5, episodeName: "Shhoplifter"},
...
// Standard format for sending info across the web
...
console.log(Object.keys(spaceJam)); //Object.keys returns array
console.log(Object.keys(spaceJam.toonSquad));

console.log(Object.keys(spaceJam.toonSquad).toString()); //converts something to a string
...
let inc = "fruit";
console.log(garden[inc]); //bracket notation allows you to pull a value for a particular key

let baking = {};

baking['zucchini'] = "better make some bread"; //add key the same way
